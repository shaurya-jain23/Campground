...
const seedDB = async ()=>{
    ...
    for(let i= 0; i<200; i++){
        ...
        const camp = await new Campground({
            ...
            images: [
                        {
                            url: 'https://res.cloudinary.com/shaurya-cloudinary/image/upload/v1748064660/YelpCamp/llqx7w1uod6gfzdqxn5h.jpg',
                            filename: 'YelpCamp/llqx7w1uod6gfzdqxn5h',
                        },
                        {
                            url: 'https://res.cloudinary.com/shaurya-cloudinary/image/upload/v1748064661/YelpCamp/fqqov5xjawymoyrwe8ic.jpg',
                            filename: 'YelpCamp/fqqov5xjawymoyrwe8ic',
                        },
                        {
                            url: 'https://res.cloudinary.com/shaurya-cloudinary/image/upload/v1748331740/YelpCamp/wm0etgplg0qmxfrq3o8k.jpg',
